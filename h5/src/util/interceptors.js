...
Vue.http.interceptors.push(function(request, next) {
  ...
  request.headers.set('Platform', 'wap')
  request.headers.set('Device-ID', window.getCookie('device'))
  request.headers.set('token', window.getCookie('token'))
