<template>
  <div>
    <div class="detail" v-if="!noDetail" ref="topicDetailRef" @scroll="handleScroll">
      ...
      <!-- <div class="topiccover" v-if="topicDetail.topicCover"><img :src="topicDetail.topicCover + imageSize()" alt=""></div> -->
      <div class="topicitems" v-if="topicItems.length" v-for="(item, index) in topicItems" :key="index">
        ...
        <div class="single" v-if="item.itemType == 1" @click="toGoodsDetail(item.singleGoods)">
          <div class="pic"><img :src="item.singleGoods.coverImage + imageSize()"></div>
        ...
        <div class="double" v-if="item.itemType == 2">
          <div class="left" @click="toGoodsDetail(item.leftGoods)">
            <div class="pic"><img :src="item.leftGoods.coverImage" alt=""></div>
          ...
          <div class="right" @click="toGoodsDetail(item.rightGoods)">
            <div class="pic"><img :src="item.rightGoods.coverImage" alt=""></div>
        ...
        <div class="singleimg-warp">
          <div class="singleimg" v-if="item.itemType == 3"><img :style="{width: item.singleWidth}" :src="item.singleImage" alt=""></div>
        </div>
        <!-- 4纯文本 -->
      ...
      <div class="footer vux-1px-t" v-if="Object.keys(topicDetail).length !== 0">
        ...
        <div class="dianzan" v-else @click.once="doDianzan(0)">
    ...
    <div v-transfer-dom>
      <popup v-model="isShowGoodsList" position="right" :hide-on-blur="true" @on-hide="onHide" :popup-style="{background: '#fff'}">
        <div style="width:310px;padding:0 12px;">
          <!-- <div class="goods_closer" @click="isShowGoodsList = false"><img src="../../assets/discovery/icon_zhankai@2x.png" alt=""></div> -->
  ...
  methods: {
    ...
    doDianzan(type) {
      ...
      this.$http.get('reportform/u_log.do', { params }).then(res => {
        // this.$emit('dianzan',this.topicId)
        bus.$emit('dianzan', [this.topicId, true])
        if (type === 0) {
